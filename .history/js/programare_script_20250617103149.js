...
// Pasul 2 -> Pasul 3 (FUNCȚIA COMPLETĂ)
btnStep2.addEventListener('click', async function () {
    ...
    // 2. VERIFICARE DUBLĂ (partea care întârzie)
    try {
        ...
        try {
            ...
            // ERROR HANDLING pentru rezervare
        ...
        // ERROR HANDLING pentru verificare
